...
<body>
	...
	<script>
		...
		*/
		...
		//서버 주소
		const url = 'ws://localhost:8090/websocket/chatserver.do';
		//const url = 'ws://http://192.168.10.30:8080//websocket/index.do';
				...
				<div class="item \${state} \${side}">
					<div>
						...
						<div style='background-color: #FFF;border: 0;'>
							<img src='/websocket/resources/emoticon/\${msg}.png'></div>
					</div>
					<div>\${time}</div>
				</div>		
				`;
